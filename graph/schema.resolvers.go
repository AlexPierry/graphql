...
// CreationCategory is the resolver for the creationCategory field.
func (r *mutationResolver) CreationCategory(ctx context.Context, input model.NewCategory) (*model.Category, error) {
...
// CreationCourse is the resolver for the creationCourse field.
func (r *mutationResolver) CreationCourse(ctx context.Context, input model.NewCourse) (*model.Course, error) {
